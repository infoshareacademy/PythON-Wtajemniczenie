...
def test_every_third_student_is_promoted_initially():
    students = [
        Student(first_name="Jan", last_name="Test"),
        Student(first_name="Ola", last_name="Test"),
        Student(first_name="Paweł", last_name="Test"),
        Student(first_name="Alicja", last_name="Test"),
        Student(first_name="Jakub", last_name="Test"),
    ]
