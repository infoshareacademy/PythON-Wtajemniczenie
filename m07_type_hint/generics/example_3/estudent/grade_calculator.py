...
class GradeCalculator:
    ...
    @staticmethod
    def normal_promotion_policy(final_grades: Sequence[FinalGrade]) -> bool:
    ...
    @staticmethod
    def strict_promotion_policy(final_grades: Sequence[FinalGrade]) -> bool:
        failing_grades = GradeCalculator.get_number_of_failing_grades(final_grades)
        if failing_grades > GradeCalculator.MAX_FAILING_GRADES_TO_PASS:
            return False
    ...
    @staticmethod
    def calculate_student_avg(final_grades: Sequence[FinalGrade]) -> float:
